...
void display_help() {
    printf("Usage: dcpu16emu [OPTIONS] [FILENAME]\n"
           ...
           "     --littleendian, -l     Interpret the words in the source "
                                       "file as little endian rather than "
                                       "big endian.\n"
           "     --disassemble,  -d     Print the instructions that make up "
                                       "the program instead of executing it.\n"
           "     --halt,         -H     Automatically stop executing if the PC "
                                       "did not change after an instruction\n"
